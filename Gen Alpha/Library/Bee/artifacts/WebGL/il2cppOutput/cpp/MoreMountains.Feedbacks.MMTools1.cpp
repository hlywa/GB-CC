...
IL_0045:
	{
		...
		(L_8)->SetAtUnchecked(static_cast<il2cpp_array_size_t>(L_9), (AudioSource_t871AC2272F896738252F04EE949AEF5B241D3299*)L_14);
		// for (int i = 0; i < PoolSize; i++)
		int32_t L_15 = V_0;
...
IL_0054:
	...
	}
	{
		...
		int32_t L_16 = L_15;
		AudioClip_t5D272C4EB4F2D3ED49F1C346DEA373CF6D585F20* L_17 = (L_13)->GetAtUnchecked(static_cast<il2cpp_array_size_t>(L_16));
...
IL_002b_1:
		...
		}
		{
			...
			int32_t L_15 = L_14;
			AudioClip_t5D272C4EB4F2D3ED49F1C346DEA373CF6D585F20* L_16 = (L_11)->GetAtUnchecked(static_cast<il2cpp_array_size_t>(L_15));
			V_2 = L_16;
		}
